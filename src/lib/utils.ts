...
export const getStatusStyle = (status: Task['status']) => {
  switch (status) {
    case 'in-progress': return 'bg-sky-500 text-white border-sky-600 shadow-sky-500/20';
    case 'in-review': return 'bg-indigo-500 text-white border-indigo-600 shadow-indigo-500/20';
    case 'completed': return 'bg-emerald-500 text-white border-emerald-600 shadow-emerald-500/20';
    default: return 'bg-amber-500 text-white border-amber-600 shadow-amber-500/20';
  }
};
