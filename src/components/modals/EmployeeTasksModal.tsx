        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-8 md:p-12 space-y-12">
            ...
            <div className="space-y-6">
              ...
              {activeTasks.length === 0 ? (
                <div className="p-12 text-center rounded-3xl border-2 border-dashed border-slate-100 bg-slate-50/20">
                  <p className="font-mono text-xs font-bold uppercase tracking-[0.2em] text-slate-400">Inventory clear. No active deployments.</p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          ...
                          <h4 className="font-serif text-lg text-slate-900 group-hover:text-emerald-700 transition-colors">
                            {task.title}
                          </h4>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          {task.status === 'in-review' && (
                            <div className="px-4 py-1 bg-indigo-50 border border-indigo-100 rounded-lg font-mono text-xs font-black uppercase tracking-widest text-indigo-600 flex items-center gap-1.5">
                ...
                {completedTasks.slice(0, 6).map((task) => (
                  ...
                  >
                    ...
                    <div className="flex-1 truncate">
                      ...
                      <div className="font-mono text-xs uppercase tracking-widest text-slate-400 font-bold mt-1">
          ...
          <div className="p-6 bg-slate-50 flex justify-center sticky bottom-0 border-t border-slate-100">
             <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-xs uppercase tracking-[0.3em] font-black text-slate-400">Identity: {selectedEmployee.uid}</span>
             </div>
          </div>
        </motion.div>
      </div>
