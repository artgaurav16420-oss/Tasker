          ...
          >
            ...
            <form onSubmit={async (e) => {
              ...
              <div className="space-y-2">
                <label htmlFor="personal-task-title" className="text-xs font-mono font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400 ml-2">Objective Title</label>
                <div className="relative group">
                  <Target className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-300 dark:text-slate-500 group-focus-within:text-emerald-500 transition-colors" />
                  <input
              ...
              <div className="space-y-2">
                <label htmlFor="personal-task-deadline" className="text-xs font-mono font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400 ml-2">Deadline (Optional)</label>
                <div className="relative group">
                  <Calendar className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-300 dark:text-slate-500 group-focus-within:text-emerald-500 transition-colors" />
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl py-4 pl-16 pr-6 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-emerald-500 focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-emerald-500/5 transition-all duration-150 font-mono text-sm"
                  />
                </div>
              </div>
