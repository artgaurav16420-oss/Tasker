          ...
          <form onSubmit={handleCreateTask} className="p-8 md:p-10 space-y-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="font-mono text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1">Target Deadline (Optional)</label>
                  <div className="relative">
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={isCreating}
                className="w-full bg-emerald-500 text-slate-950 font-mono text-xs font-black uppercase tracking-[0.3em] py-6 rounded-xl hover:bg-emerald-400 transition-all duration-150 shadow-xl dark:shadow-slate-900/50 shadow-emerald-500/20 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-4"
              >
                {isCreating ? (
